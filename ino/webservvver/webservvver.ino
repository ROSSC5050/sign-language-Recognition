...
void sendPredictedGesture(String gesture) {
  // Craft the HTML response with the predicted gesture and styling
String response = "<!DOCTYPE html><html><head><title>Predicted Gesture</title>";
  ...
  response += "document.getElementById('predicted-gesture').textContent = 'Predicted Gesture: ' + xhr.responseText;";
  response += "}";
  response += "};";
